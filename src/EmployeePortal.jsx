    ...
    <div className="min-h-screen bg-[#EEF4F4]">
      ...
      <header className="border-b border-slate-200 bg-white">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 sm:px-6 py-4">
          <div className="flex items-center gap-3">
            <img src={logo} alt="Enterprise-Infotech Logo" className="h-10 sm:h-14 w-auto object-contain" />
          </div>
            ...
            <div className="hidden md:block rounded-xl border border-slate-200 bg-white shadow-sm">
              <table className="w-full table-fixed border-collapse text-left text-xs lg:text-sm text-slate-700">
                <thead className="border-b border-slate-200 bg-slate-50 font-semibold uppercase tracking-wider text-slate-500">
                  <tr>
                    <th scope="col" className="w-[18%] px-2 lg:px-3 py-3.5 border-r border-slate-100">Name</th>
                    <th scope="col" className="w-[14%] px-2 lg:px-3 py-3.5 border-r border-slate-100">Phone number</th>
                    <th scope="col" className="w-[20%] px-2 lg:px-3 py-3.5 border-r border-slate-100">Email</th>
                    <th scope="col" className="w-[11%] px-2 lg:px-3 py-3.5 border-r border-slate-100 text-center">Primary Credential</th>
                    <th scope="col" className="w-[7%] px-2 lg:px-3 py-3.5 border-r border-slate-100 text-center">MFA</th>
                    <th scope="col" className="w-[14%] px-2 lg:px-3 py-3.5 border-r border-slate-100 text-center">Sent At</th>
                    <th scope="col" className="w-[16%] px-2 lg:px-3 py-3.5 text-center">Actions</th>
                  </tr>
                </thead>
